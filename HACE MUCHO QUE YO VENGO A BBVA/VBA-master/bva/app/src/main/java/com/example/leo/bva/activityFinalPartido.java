...
public class activityFinalPartido extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Integer TriplesTirados=TriplesErrados+TriplesMetidos;
        ...
        if(porTL.isNaN()==false) {
            porcTl.setText("TL: %" +  String.format("%.2f", porTL));
        }else{
            porcTl.setText("TL: %0");
        }


        if(porTriples.isNaN()==false) {
            txtPorTriples.setText("3PT: %" + String.format("%.2f", porTriples));
        }
        else{
            txtPorTriples.setText("3PT: %0");

        }
        if(porDoble.isNaN()==false) {
            txtPorDobles.setText("2PT: %" + String.format("%.2f", porDoble));
        }
        else{
            txtPorDobles.setText("2PT: %0");
